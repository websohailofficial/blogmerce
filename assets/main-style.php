...
function blogmerce_enqueue_styles()
{
    ...
    $custom_css = '
        ...
        .blog-section .single-blog .blog-content{
            background-color: ' . get_theme_mod('content_bg_color', '#ffff') . ';
        }
        .entry-title a{
       ...
       .sidebar .widget{
        ...
        footer .footer-bottom{
            background-color: ' . get_theme_mod('footer_bottom_bg_color', '#ffff') . ';
        }
        ...
        .header .menu-item a{
            color: ' . get_theme_mod('header_menu_color', '#fff') . ';
        }
        .header .menu-item a:hover{
            color: ' . get_theme_mod('header_menu_hover_color', '#000000') . ';
        }
    ';
