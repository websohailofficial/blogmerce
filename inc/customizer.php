...
function blogmerce_customize_register($wp_customize)
{
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'header_menu_color', array(
        'label'    => __('Navigation Menu Color', 'blogmerce'),
        'section'  => 'header_section',
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'header_menu_hover_color', array(
        'label'    => __('Navigation Menu Hover Color', 'blogmerce'),
        'section'  => 'header_section',
    ...
    // Add Color setting for the Footer Background 
    ...
    // Add Color setting for the Footer Bottom Background 
